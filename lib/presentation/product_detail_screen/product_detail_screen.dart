...
import 'package:aditya_s_application1/widgets/app_bar/appbar_trailing_image.dart';
import 'package:aditya_s_application1/widgets/app_bar/custom_app_bar.dart';
import 'package:aditya_s_application1/widgets/custom_elevated_button.dart';
import 'package:aditya_s_application1/widgets/custom_rating_bar.dart';
...
class ProductDetailScreen extends StatelessWidget {
  ...
  Widget _buildSpecifications(BuildContext context) {
    return Container(
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          _buildStyle(context,
              dynamicText1: "Shown:",
              dynamicText2: "Laser Blue/Anthracite/Watermelon/White"),
          SizedBox(height: 18.v),
          _buildStyle(context,
              dynamicText1: "Style:", dynamicText2: "CD0113-400"),
  ...
  Widget _buildReview(BuildContext context) {
    return Container(
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          _buildStyle(context,
              dynamicText1: "Review Product",
              dynamicText2: "See More", onTapStyleCode: () {
