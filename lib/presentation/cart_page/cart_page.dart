...
import 'package:aditya_s_application1/widgets/app_bar/appbar_title.dart';
...
import 'package:aditya_s_application1/widgets/custom_text_form_field.dart';
  ...
  Widget _buildTotalPriceDetailsColumn(BuildContext context) {
    return Container(
        ...
        child: Column(
            ...
            children: [
              _buildShippingPriceRow(context,
